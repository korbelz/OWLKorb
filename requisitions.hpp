	...
	class OpenWarlords
	{
		class WEST
		{
			...
			class Vehicles
			{
				...
				class B_G_Van_01_fuel_F				{cost = 750;	requirements[]={};	};	// "Fuel Van"
			...
			class Aircraft
			{
				...
				class B_Heli_Transport_01_F			{cost = 2000;	requirements[]={"H"};	};	// "UH-80 Ghost Hawk"
				class B_Heli_Transport_03_F			{cost = 3500;	requirements[]={"H"};	};	// "CH-67 Huron"
				class B_Heli_Attack_01_dynamicLoadout_F		{cost = 6000;	requirements[]={"H"};	};	// "AH-99 Blackfoot"
				class B_T_VTOL_01_armed_F			{cost = 7000;	requirements[]={"H"};	};	// "V-44 X Blackfish (Armed)"
		...
		class EAST
		{
			...
			class Vehicles
			{
				...
				class O_G_Van_01_fuel_F				{cost = 750;	requirements[]={};	};	// "Fuel Van"
				...
				class O_G_Offroad_01_repair_F			{cost = 1250;	requirements[]={};	};	// "Repair car"
			...
			class Aircraft
			{
				...
				class O_Heli_Transport_04_F			{cost = 2000;	requirements[]={"H"};	};	// "Mi-290 Taru"
				class O_Heli_Transport_04_covered_F		{cost = 2000;	requirements[]={"H"};	};	// "Mi-290 Taru (Transport)"
